                    ...
                    <table className="table cart_table shop_table_responsive">
                      <thead>
                        <tr>
                          ...
                          <th className="product-subtotal">Policy ID</th>
                          <th className="product-subtotal">Policy Name</th>
                      ...
                      <tbody>
                        {filteredData?.map((item, index) => (
                          <tr key={index}>
                            ...
                            <th className="product-subtotal">
                              <Link to={`/policies/${item.id}`}>View</Link>
                            </th>
                            {/* <th className="product-subtotal">
