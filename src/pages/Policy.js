...
const Policy = () => {
  ...
  const tabs = [
    ...
    { id: "tab5", label: "Subscriptions" },
    { id: "tab6", label: "Claims" },
  ];
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch beneficiaries for this policy
        const { data: beneficiaryData, error: beneficiaryError } =
          await supabase.from("beneficiaries").select("*").eq("policy_id", id);
                  ...
                  <div id="ttm-contactform" className="wrap-form clearfix">
                    <div className="row">
                      <div className="col-lg-6">
                        <h5>SECTION A : Main Member Information</h5>
                      </div>
                    </div>
                    <div className="row">
                ...
                <div>
                  ...
                  <div>
                    ...
                    >
                      <div className="row">
                        <div className="col-lg-6">
                          <h5>SECTION C: Beneficiaries Information</h5>
                        </div>
                      </div>
