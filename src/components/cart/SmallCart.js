...
const SmallCart = (props) => {
    ...
    const [getCartProducts, { data, error, loading }] = useLazyQuery(CART_PRODUCTS_QUERY, {
        variables: { "ids": ids },
        // pollInterval: 1000,
    });
    ...
    console.log('fun loading', loading);
        ...
        const sumQuantity =
             props.cart?.reduce((partialSum, a) => partialSum + a.quantity, 0);
	...
	return (
		<>
       <span class="badge badge--circle">{sumQuantity}</span>
         <IoMdBasket  size={35}/>
