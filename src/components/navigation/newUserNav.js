            ...
            <div className="container">
              <div className="row">
                <div className="col l3 s4">
                  ...
                  <button id="main-nav-toggle" className="c-navicon c-navicon--spin mobile" aria-label="Menu" role="button">
                          ...
                          <div className="c-nav-primary__subcategory-nav__content">
                            ...
                            <ul className="menu--tier-3">
                              ...
                              {subCategory?.products?.map((product, index)=> (
                                <li key ={index} >
                                 <a className="c-nav-primary__subcategory-nav__subcategory-name" href="insulation/insulation-boards/celotex-insulation-board.html">{product.name}</a>
                                </li>) )
                              }
